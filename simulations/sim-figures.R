...
pdf("~/repos/Group-Sequential-Trials-Paper/figures/type1error.pdf", height=5, width=10)
...
pdf("~/repos/Group-Sequential-Trials-Paper/figures/power.pdf", height=5, width=10)
